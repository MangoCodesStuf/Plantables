...
- Web Browser (Faster) -
You can also do this quicker, a web browser way, but you will not be able to edit the code in any language unless you make a copy. You will need a microbit V2 and a USB-C cable. Visit https://makecode.microbit.org/S33658-97128-91970-91474. Don't get scared if the code looks complex now; you only need to download it and start by clicking on the button that says Simulator (It's next to blocks and Java). When you open the simulator, it will show you a preview of what Plantables looks like. You can ignore it, then connect your microbit to your device with a USB-C cable and click download. If this does not work, you might need to download a file or check updates for your web browser
