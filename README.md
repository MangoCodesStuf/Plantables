...
You can also do this quicker, a web browser way, but you will not be able to edit the code in any language unless you make a copy. You will need a microbit V2 and a USB-C cable. Visit https://makecode.microbit.org/S33658-97128-91970-91474. Don't get scared if the code looks complex now; you only need to download it and start by clicking the button labeled "Simulator" (it's next to blocks and Java). When you open the simulator, it will show you a preview of what Plantables looks like. You can ignore it, then connect your microbit to your device with a USB-C cable and click download. If this does not work, you might need to download a file or check updates for your web browser. If you would like to edit or modify code, you can click the edit button, and it will make a copy for you to experiment with and discover.
...
## Overview
  ...
  modable, you can edit our code in Blocks, Java, and Python. Plantables is free, the microbit V2 costs around $25, in contrast to other 60-120$ boards its great and small. Perfect for getting into code or exploring fun projects. If you have any questions, read the FAQ questions
